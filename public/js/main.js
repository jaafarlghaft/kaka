...
$(function () {
  ...
  var heroInnerPage = function () {
    ...
    setTimeout(function () {
      tl.set(".inner-page .hero-heading > span > span > span > span", {
        y: "100%",
        transformStyle: "preserve-3d",
      })
        .set(".inner-page .sub-text", {
          y: 20,
          autoAlpha: 0,
          transformStyle: "preserve-3d",
        })
        .staggerFromTo(
          ".inner-page .hero-heading > span > span > span > span",
          2,
    ...
    owlHeroSlider.owlCarousel({
      ...
      onInitialize: function () {
        setTimeout(function () {
          ...
          tl.set(".owl-item.active .hero-heading > span > span > span > span", {
            y: "100%",
            transformStyle: "preserve-3d",
          })
            .set(".owl-item.active .sub-text", {
              y: 20,
              autoAlpha: 0,
              transformStyle: "preserve-3d",
            })
