...
function es({categories, items}: Props) {
  return (
  <>
            ...
            {categories.map(cat=> (
              <div className="row">
                <div className="col-md-12 text-center mb-5" data-aos="fade">
                  <h2 className="display-4 mb-4">{cat.es_title}</h2>
                ...
                <div className="col-md-12 text-center">
                  ...
                  >
                      ...
                      {items.filter((item:any) => {
                        return item.categories[0].es_title == cat.es_title
                      }).map(item => (
                        <div className="col-md-6">
                          <div className="media block-templateux-menu-item">
                            ...
                            <div className="media-body">
                              <h5 className="mt-0">{item.es_title}</h5>
                              <p>
                                {item.es_desc}
                              </p>
